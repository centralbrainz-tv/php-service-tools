...
for ($index = 900233; $index <= 999999; $index++) {
    if (!in_array($index, $broken)) {
        ...
        if ($doc) {
            ...
            $h4FullCredit =
                $docFullCredit &&
                count($docFullCredit->find('#fullcredits_content')) > 0
                    ? $docFullCredit
                        ->find('#fullcredits_content')[0]
                        ->find('h4')
                    : [];
            $tableFullCredit =
                $docFullCredit &&
            ...
            $plotSummaryName =
                $docPlotSummary &&
                count($docPlotSummary->find('#summaries')) > 0
            ...
            $synopsisName =
                $docPlotSummary && count($docPlotSummary->find('#synopsis')) > 0
                    ? $docPlotSummary->find('#synopsis')[0]->innertext
                    : "Summaries";
            $synopsisUl =
                $docPlotSummary &&
                count($docPlotSummary->find('#plot-synopsis-content')) > 0
                    ? $docPlotSummary
                        ->find('#plot-synopsis-content')[0]
                        ->find('li')
                    : [];
            ...
            $sections =
                $docParentalGuide &&
                count(
                    $docParentalGuide->find(
                        'section.article.listo.content-advisories-index'
                    )
                ) > 0
                    ? $docParentalGuide
                        ->find(
            ...
            $awardsHeads =
                $docAwards && count($docAwards->find('.article.listo')) > 0
